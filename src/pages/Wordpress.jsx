  ...
  const durations = [
    {
      ...
      description: "Découvrez les bases de WordPress",
      link:"https://www.moncompteformation.gouv.fr/espace-prive/html/#/formation/recherche/83277408700023_Wordpress-1/83277408700023_Wordpress-1?contexteFormation=ACTIVITE_PROFESSIONNELLE"
      
    },
    {
      hours: "33h",
      title: "Formation Intermédiaire",
      description: "Maîtrisez la création de sites",
      link:"https://www.moncompteformation.gouv.fr/espace-prive/html/#/formation/recherche/83277408700023_Wordpress-1/83277408700023_Wordpress-2?contexteFormation=ACTIVITE_PROFESSIONNELLE"
    ...
    },
    {
      ...
      description: "Devenez expert WordPress",
      link:"https://www.moncompteformation.gouv.fr/espace-prive/html/#/formation/recherche/83277408700023_Wordpress-1/83277408700023_Wordpress-3?contexteFormation=ACTIVITE_PROFESSIONNELLE"
        ...
        <div className="relative h-full flex items-center justify-center px-4">
          <div className="text-center text-white max-w-4xl">
            ...
            <p className="text-xl text-purple-200">
              Créez et gérez votre site web professionnel avec WordPress
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-2xl shadow-md p-8 mb-8">
            ...
            <p className="text-gray-700 text-lg leading-relaxed">
              Apprendre à créer son site internet avec le CMS WordPress. Cette formation vous permettra de créer, gérer et optimiser le contenu d'un blog professionnel ou d'un site internet dynamique avec WordPress.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            ...
            <div className="bg-white rounded-2xl shadow-md p-8">
              ...
              <p className="text-gray-700">
                Les prérequis sont une bonne connaissance du Web en général et des outils de bureautique.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-md p-8 mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              Cette formation s'adresse aux professionnels, aux entrepreneurs, aux personnes en reconversion, aux demandeurs d'emplois et à toute personne cherchant à disposer d'un site internet et devant communiquer sur ses activités, attirer de nouveaux clients, présenter des offres et mettre en avant des contenus.
            </p>
          </div>
          ...
          {/* Statistiques */}
          <div className="bg-gradient-to-br from-purple-600 to-purple-700 rounded-2xl shadow-md p-8 text-white mb-8">
